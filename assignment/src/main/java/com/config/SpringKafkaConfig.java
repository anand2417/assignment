...
import com.animal.bean.Animal ;
    ...
    public class SpringKafkaConfig {
        ...
        public ProducerFactory<String, Object> producerFactory() {
            ...
            configMap.put(JsonDeserializer.TRUSTED_PACKAGES, "com.animal");
        ...
        public ConcurrentKafkaListenerContainerFactory<String,Animal> kafkaListenerContainerFactory() {
            ConcurrentKafkaListenerContainerFactory<String, Animal> factory = new ConcurrentKafkaListenerContainerFactory<String, Student>();
